...
We started by identifying \GH projects that ever used \Tvis.
...
We then proceeded to aggregate data about the different practices considered
in 30-day windows, 12 on each side, around the \Tvis adoption event.

\begin{figure}[t]
	\centering
	\includegraphics[width=\columnwidth, clip=true, trim=0 395 0 40]{figures/timeline.pdf}
