...
\begin{figure}[t]
	...
	\caption{RDD illustration.\vf{Replace this with PDF version and bigger fonts}}
...
The survey questions have been intended 

In order not to bias the responses, none of the questions was mandatory, and no monetary reward 