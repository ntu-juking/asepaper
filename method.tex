...
For the commits, we distinguish between \emph{non-merge commits} 
and \emph{merge commits}, and further annotate the non-merge commits 
as \emph{bug-fixing or not} (by searching fix patterns, \eg ``fix bug'', in the commit messages).
