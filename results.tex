...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth, clip=true, trim=0 0 0 0]{figures/freq-non-merge1.pdf}
...
The horizontal line in each boxplot is the median value, computer across all
projects.
Note the log scale in both plots.
