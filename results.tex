...
median or average non-merge commit frequency, but we do observe an upward trend in merge commits.
...
However, we see a strong increasing trend in the merge commits over the majority of the projects.
