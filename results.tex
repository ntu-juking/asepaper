...
\caption{Closed pull requests before and after the \Tvis adoption.}\vspace{-0.6cm}
\label{fig:prs}
\end{figure}
...
\caption{Mean pull request latency before and after the \Tvis adoption.}\vspace{-0.7cm}
...
One possible explanation of the increased latency is the %low performance 
slowness of \Tvi, 
