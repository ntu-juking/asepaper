...
Under this definition %Deshpande and Riehle %based on Ohloh.net data~\cite{Deshpande2008}
%under the assumption that it reduces the size of commits (to facilitate coordination
%in distributed settings), but 
...
In our work we adopt a similar evolutionary perspective% and \emph{within-subject design}
...
%
%There are also reports of experiences with applying CI in specific domains, such as neuroinformatics~\cite{Zaytsev:Morrison} and software-intensive embedded systems~\cite{Martensson2016}.
...
%time-to-marked without compromising quality~\cite{Zaytsev:Morrison}; 
...
%used Continuous Test Generation (CTG) to 
...
%to analyze the dependencies between the code of various projects 
