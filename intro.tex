...
\item Following CA adoption there are downward trends in commit churn, for ca. 10\% of 
individual projects (for ca. 86\% no statistical evidence for a trend could be found,
...
\item We also find that the commit frequency for both merge and non-merge commits does 
...
The remainder of this paper starts by developing the research questions 
