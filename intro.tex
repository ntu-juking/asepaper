...
and testing, and pursue a mixed-methods approach.
Quantitatively, to evaluate the effect of an intervention, in our case 
...
\GH projects, appropriately selected), we introduce \emph{regression 
discontinuity design analyses}.
...
Applying this methodology, we find that:
