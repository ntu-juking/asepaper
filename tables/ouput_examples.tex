...
\begin{tabular}{ p{8cm}}
	...
	\hline
		...
		\begin{tabular}[c]{@{}l@{}}
			...
			\textit{  Tests run: 1, Failures: 0, Errors: 0, Skipped: 0, Time elapsed:}\\ 
		...
		\begin{tabular}[c]{@{}l@{}}
			...
			\textit{  {[}junit{]} Tests run: 5, Failures: 0, Errors:0, Time elapsed:}\\
			\textit{ \space\space0.143sec} \end{tabular}                                                                                                                                                \\  \hline
		\hline
		\textbf{GRADLE}          \\
		\begin{tabular}[c]{@{}l@{}}
			\textit{  :test}\\ 
